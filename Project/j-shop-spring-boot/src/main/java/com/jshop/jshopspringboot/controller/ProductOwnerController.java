...
public class ProductOwnerController {
	...
	@PutMapping("/updateProductOwner")
	public ResponseStructure<ProductOwner> updateProductOwnerController(@RequestBody ProductOwner productOwner){
		return ownerService.updateProductOwnerService(productOwner);
	}
